namespace MuuqWear.Model.PartnerStoreProduct;

public class PartnerStoreProductModel
{
    /// <summary>
    ...
    /// </summary>
    public List<ProductSizeStockModel> SizeStock { get; set; } = new();
...
/// </summary>
public class ProductSizeStockModel
{
    /// <summary>
    /// Size (S, M, L, XL, etc.)
    /// </summary>
