...
public class AffiliatePendingPayoutModel
{
...
public class ProcessAffiliatePayoutModel
{
    public string? PaymentMethod { get; set; }
    public string? AdminNotes { get; set; }
}

public class AffiliatePayoutResultModel
{
    ...
    public string? PaymentMethod { get; set; }
    public string FormattedDate => ProcessedAt.ToString("MMM dd, yyyy");
    public string FormattedAmount => $"${TotalAmount:F2}";
